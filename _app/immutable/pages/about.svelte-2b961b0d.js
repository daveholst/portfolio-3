import{S as P,i as C,s as F,x as N,k as u,e as h,t as x,y as T,m as y,c as g,a as v,h as $,d as c,K as U,b as i,z as W,g as S,J as n,n as j,r as z,p as B,C as G}from"../chunks/index-a1628edd.js";import{N as J}from"../chunks/NavBar-0026f8bb.js";function K(q){let s,d,t,o,A,f,l,k,w,r,_,b,m,I,p;return s=new J({}),{c(){N(s.$$.fragment),d=u(),t=h("div"),o=h("img"),f=u(),l=h("p"),k=x(`I'm a 32 years old country kid with a passion for technology and the
        ...
        they work and if they will go back together again.`),w=u(),r=h("p"),_=x(`My personal technology interests include making, programming,
        ...
        call myself a Full Stack Developer.`),b=u(),m=h("p"),I=x(`I have previously worked as a Design & Technology teacher and have a
        ...
        a new context.`),this.h()},l(e){T(s.$$.fragment,e),d=y(e),t=g(e,"DIV",{class:!0});var a=v(t);o=g(a,"IMG",{src:!0,alt:!0,class:!0}),f=y(a),l=g(a,"P",{class:!0});var D=v(l);k=$(D,`I'm a 32 years old country kid with a passion for technology and the
        outdoors. I like to spend my time camping, hiking, kite-surfing,
        fishing, diving and doing multi-day motorbike expeditions out in the
        desert. I've always been a tinkerer, pulling things apart to see how
        they work and if they will go back together again.`),D.forEach(c),w=y(a),r=g(a,"P",{class:!0});var E=v(r);_=$(E,`My personal technology interests include making, programming,
        electronics, home-automation and home-labbing. I'm always on the quest
        to see what I can create to make life easier, this has lead me to
        automate my entire house using a mix of open-source, self designed and
        commercial products. All these devices become compatible with each other
